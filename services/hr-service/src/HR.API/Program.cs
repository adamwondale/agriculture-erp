...
using HR.Infrastructure.Messaging.Consumers;
using HR.Infrastructure.Messaging.Publishers;
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Clean Architecture Microservice for HR"
    });
...
var connectionString = builder.Configuration.GetConnectionString("DefaultConnection") 
    ?? "Host=localhost;Port=5432;Database=agri_hr_db;Username=postgres;Password=postgres";

builder.Services.AddDbContext<HRDbContext>(options =>
    options.UseNpgsql(connectionString, b => b.MigrationsAssembly(typeof(HRDbContext).Assembly.FullName)));
