...
namespace ComplianceTraceability.Infrastructure.Messaging.Consumers;
...
public class EventConsumerStub : BackgroundService
{
    ...
    {
        _logger.LogInformation("ComplianceTraceability Event Consumer background service active.");
