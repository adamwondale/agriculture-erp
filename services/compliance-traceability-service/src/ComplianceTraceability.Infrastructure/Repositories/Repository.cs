...
namespace ComplianceTraceability.Infrastructure.Repositories;

public class Repository<T> : IRepository<T> where T : BaseEntity
{
    protected readonly ComplianceTraceabilityDbContext _context;

    public Repository(ComplianceTraceabilityDbContext context)
    {
        _context = context;
    }
