...
namespace CustomerInvestorPortal.Infrastructure.Messaging.Consumers;
...
public class EventConsumerStub : BackgroundService
{
    ...
    {
        _logger.LogInformation("CustomerInvestorPortal Event Consumer background service active.");
